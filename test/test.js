...
describe("Prueba de extract()", ()=>{
  ...
  it('Debería Devolver true si el string posee enlaces []()', () => {
    if (typeof extract_links.extract(str) !== 'object') {
      console.error('✗ fail');
    } else {
      console.log('✓ ok');
    } 
  ...
  it('Debería Devolver false si el string No posee enlaces []() e indicar No Links', () => {
    if ( typeof extract_links.extract(str4) !== 'string') {
      console.error('✗ fail');
    } else {
      console.log('✓ ok ' + extract_links.extract(str4));
    } 
  });
...
describe("Prueba de hasLinks()", ()=>{
  ...
  it('Debería Devolver true si el string posee enlaces []()', () => {
    if (extract_links.hasLinks(str) !== true) {
      console.error('✗ fail');
    } else {
      console.log('✓ ok');
    } 
  ...
  it('Debería Devolver false si el string No posee enlaces []()', () => {
    if (extract_links.hasLinks(str4) !== false) {
      console.error('✗ fail');
    } else {
      console.log('✓ ok');
    } 
...
describe("Prueba de sameSize()", ()=>{
  ...
  it('Debería Devolver true si los array son de Igual Tamaño', () => {
    if (extract_links.sameSize([1,23,'d'],['ee',{},11]) !== true) {
      console.error('✗ fail');
    } else {
      console.log('✓ ok');
    } 
  ...
  it('Debería Devolver false si los array NO son de Igual Tamaño', () => {
    if (extract_links.sameSize([1,23],['ee',{},11]) !== false) {
      console.error('✗ fail');
    } else {
      console.log('✓ ok');
    } 
